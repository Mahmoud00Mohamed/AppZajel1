...
const GiftAssistantPage: React.FC = () => {
  ...
  const occasions = [
    ...
    { id: "anniversary", label: isRtl ? "ذكرى سنوية" : "Anniversary", icon: "💕" },
  ...
  const budgetRanges = [
    { id: "low", label: isRtl ? "أقل من 200 ر.س" : "Under 200 SAR", min: 0, max: 199 },
    { id: "medium", label: isRtl ? "200 - 500 ر.س" : "200 - 500 SAR", min: 200, max: 500 },
    { id: "high", label: isRtl ? "500 - 1000 ر.س" : "500 - 1000 SAR", min: 500, max: 1000 },
    { id: "luxury", label: isRtl ? "أكثر من 1000 ر.س" : "Over 1000 SAR", min: 1000, max: Infinity },
  ];

  const interests = [
    { id: "beauty", label: isRtl ? "الجمال والعناية" : "Beauty & Care", icon: "💄" },
    ...
    let filteredProducts = allProducts.filter(product => {
      ...
      if (form.interests.length > 0) {
        return form.interests.some(interest => {
          switch (interest) {
            case "beauty":
              return product.categoryId === "beauty-care" || product.categoryId === "personal-care";
            case "flowers":
          ...
          {recommendations.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-4">
                {isRtl ? "لم نجد اقتراحات مناسبة" : "No Suitable Recommendations"}
              </h3>
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 to-purple-50 py-8 px-4 sm:px-6 lg:px-8 font-serif text-neutral-800">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-purple-800 mb-4">
            {isRtl ? "مساعد اختيار الهدية المثالية" : "Perfect Gift Selection Assistant"}
          </h1>
            ...
            {[1, 2, 3, 4].map((step) => (
              <React.Fragment key={step}>
                <motion.div
                  ...
                  transition={{ duration: 0.6, repeat: currentStep === step ? Infinity : 0 }}
                >
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    {isRtl ? "اختر المناسبة المناسبة" : "Choose the right occasion"}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {occasions.map((occasion) => (
                    <motion.button
                      key={occasion.id}
                      type="button"
                      onClick={() => setForm({ ...form, occasion: occasion.id })}
                ...
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-800 mb-2">
                    {isRtl ? "ما هي علاقتك بالمستقبل؟" : "What's your relationship?"}
                  </h3>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {relationships.map((relationship) => (
                    <motion.button
                      key={relationship.id}
                      type="button"
                      onClick={() => setForm({ ...form, relationship: relationship.id })}
                      className={`p-4 rounded-xl border transition-all duration-300 ${
                    ...
                    >
                      ...
                      <div className="font-medium text-sm">{relationship.label}</div>
                    </motion.button>
                  ))}
                </div>
              </motion.div>
            ...
            {currentStep === 2 && (
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    {isRtl ? "اختر النطاق السعري المناسب" : "Choose your price range"}
                  </p>
                </div>
                  ...
                  {budgetRanges.map((budget) => (
                    ...
                    >
                      ...
                      <div className={`text-sm ${
                        form.budget === budget.id ? "text-white/80" : "text-gray-500"
                      }`}>
                        {budget.id === "luxury" 
                          ? isRtl ? "للهدايا الفاخرة" : "For luxury gifts"
                          : isRtl ? "مناسب للمعظم" : "Suitable for most"
                        }
                      </div>
                    </motion.button>
                  ))}
            ...
            {currentStep === 3 && (
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    {isRtl ? "اختر الاهتمامات المناسبة (يمكن اختيار أكثر من واحد)" : "Select relevant interests (multiple choices allowed)"}
                  </p>
                </div>
            ...
            {currentStep === 4 && (
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    {isRtl ? "لمساعدتنا في تقديم اقتراحات أفضل" : "To help us provide better suggestions"}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        { id: "child", label: isRtl ? "طفل (أقل من 12)" : "Child (Under 12)" },
                        { id: "teen", label: isRtl ? "مراهق (12-18)" : "Teen (12-18)" },
                        { id: "adult", label: isRtl ? "بالغ (18-60)" : "Adult (18-60)" },
                        { id: "senior", label: isRtl ? "كبير السن (60+)" : "Senior (60+)" },
                      ].map((age) => (
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        { id: "unisex", label: isRtl ? "مناسب للجميع" : "Unisex" },
                      ].map((gender) => (
                        <label key={gender.id} className="flex items-center gap-3 cursor-pointer">
                          <input
                            type="radio"
                            name="gender"
                            value={gender.id}
            ...
            >
              {isAnalyzing ? (
                ...
                <>
                  <span>
                    {currentStep === 4
                      ? isRtl ? "العثور على الهدايا" : "Find Gifts"
                      : isRtl ? "التالي" : "Next"}
                  </span>
