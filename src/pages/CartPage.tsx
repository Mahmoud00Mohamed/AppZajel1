      ...
      <div className="min-h-screen bg-gradient-to-br from-rose-50 to-purple-50 flex items-center justify-center p-4 font-serif text-neutral-800">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            {isRtl
              ? "يجب تسجيل الدخول لعرض وإدارة عربة التسوق الخاصة بك"
              : "Please login to view and manage your shopping cart"}
          </p>
          <div className="flex flex-col gap-3">
            <Link
              to="/auth/login"
              className="bg-gradient-to-r from-purple-600 to-pink-500 text-white py-3 px-6 rounded-xl font-medium hover:from-purple-700 hover:to-pink-600 transition-all shadow-lg flex items-center justify-center gap-2"
            >
              <LogIn size={18} />
            ...
            <Link
              to="/auth/signup"
              className="bg-white text-purple-600 border border-purple-200 py-3 px-6 rounded-xl font-medium hover:bg-purple-50 transition-all flex items-center justify-center gap-2"
            >
              <User size={18} />
